...
This project uses a **synthetic food delivery dataset** created for portfolio purposes. It is based on a food delivery dataset 

The dataset was expanded to simulate realistic platform behavior, including:
